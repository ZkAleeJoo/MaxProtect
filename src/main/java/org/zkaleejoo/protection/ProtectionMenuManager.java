...
public class ProtectionMenuManager {
    ...
    public ProtectionMenuManager(MaxProtections plugin) {
        this.plugin = plugin;
    ...
    public void openMenu(Player player) {
        ...
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder("PROTECTION_MENU"),
    ...
    public void openInfoMenu(Player player, ProtectionMenuContext context) {
        ...
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder("INFO_MENU"),
    ...
    public void openRemoveConfirmMenu(Player player, ProtectionMenuContext context) {
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder(REMOVE_CONFIRM_MENU_ID, context.regionId()),
    ...
    public void handleRemoveConfirmClick(Player player, int slot, MaxProtectionsHolder holder) {
    ...
    public void openHomeMenu(Player player, int page) {
        ...
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder(HOME_MENU_ID, String.valueOf(safePage)),
    ...
    public void handleHomeMenuClick(Player player, int slot, ItemStack clicked, MaxProtectionsHolder holder) {
    ...
    public void openAdminPlacedMenu(Player player, int page) {
        ...
        int maxPage = maxPage(protections.size(), contentSlots.size());
        int safePage = Math.max(0, Math.min(page, maxPage));
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder(ADMIN_PLACED_MENU_ID, String.valueOf(safePage)),
    ...
    public void handleAdminPlacedMenuClick(Player player, int slot, ItemStack clicked, MaxProtectionsHolder holder) {
        int page = parsePage(holder.getContextId());
    ...
    public void openMembersMenu(Player player, ProtectionMenuContext context, int page) {
        ...
        int safePage = Math.max(0, Math.min(page, maxPage));
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder(MEMBERS_MENU_ID,
    ...
    private void openSettingsMenu(Player player, int page, boolean playOpenSound) {
        ...
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder(SETTINGS_MENU_ID, String.valueOf(safePage)),
    ...
    public void handleSettingsMenuClick(Player player, int slot, MaxProtectionsHolder holder) {
        int page = parsePage(holder.getContextId());
    ...
    private ItemStack buildHomeItem(Player player, ProtectionMenuContext context) {
        ...
        String rank = switch (playerRank == null ? ProtectionMemberRank.ADMIN : playerRank) {
            ...
            case ADMIN -> playerRank == null && player.hasPermission(MaxProtectionsPermissions.ADMIN)
    ...
    public void openLogsMenu(Player player, ProtectionMenuContext context, int page) {
        ...
        int safePage = Math.max(0, Math.min(page, maxPage));
        Inventory inv = Bukkit.createInventory(new MaxProtectionsHolder(LOGS_MENU_ID,
