...
public class SettingsSubCommand implements PluginSubCommand {

    private final ProtectionCommandContext context;

    public SettingsSubCommand(ProtectionCommandContext context) {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        context.plugin().getProtectionMenuManager().openSettingsMenu(player);
    }
}
