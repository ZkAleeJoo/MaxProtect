...
public class HomeSubCommand implements PluginSubCommand {

    private final ProtectionCommandContext context;

    public HomeSubCommand(ProtectionCommandContext context) {
        this.context = context;
    }

    @Override
    public List<String> aliases() {
        return List.of("home", "homes");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        context.plugin().getProtectionMenuManager().openHomeMenu(player);
    }
}
